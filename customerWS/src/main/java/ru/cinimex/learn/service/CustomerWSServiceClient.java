 ...
 * 2017-06-09T16:20:03.255+03:00
 * Generated source version: 3.1.5.redhat-630254
 * 
 */
@WebServiceClient(name = "customerWS_ServiceClient", 
                  wsdlLocation = "file:/C:/Users/efischenko/Desktop/task2/customerWS/src/main/resources/wsdl/customerWS.wsdl",
                  targetNamespace = "http://learn.cinimex.ru/service") 
public class CustomerWSServiceClient extends Service {

    public final static URL WSDL_LOCATION;

    public final static QName SERVICE = new QName("http://learn.cinimex.ru/service", "customerWS_ServiceClient");
    public final static QName CustomerWSPort = new QName("http://learn.cinimex.ru/service", "customerWS_Port");
    static {
        URL url = null;
        try {
            url = new URL("file:/C:/Users/efischenko/Desktop/task2/customerWS/src/main/resources/wsdl/customerWS.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(CustomerWSServiceClient.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "file:/C:/Users/efischenko/Desktop/task2/customerWS/src/main/resources/wsdl/customerWS.wsdl");
        }
        WSDL_LOCATION = url;
    }
